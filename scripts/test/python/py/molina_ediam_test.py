...
def molina_ediam(Yre_N_init,Yce_N_init,Yre_S_init,Yce_S_init,S_init,t):
    ...
    return Are_N+dAre_N,Ace_N + dAce_N,Are_S + dAre_S,Ace_S + dAce_S,Yce_N,Yce_S,S+dS
...
for t in range(1,T):
    if t==1:
        Are_N,Ace_N,Are_S,Ace_S,Yce_N,Yce_S,S = molina_ediam(Yre_N_0,Yce_N_0,Yre_S_0,Yce_S_0,S_0,t)
        N_fossil_energy.append(Yce_N)
        S_fossil_energy.append(Yce_S)
    else:
        Are_N,Ace_N,Are_S,Ace_S,Yce_N,Yce_S,S = molina_ediam(Are_N,Ace_N,Are_S,Ace_S,S,t)
        N_fossil_energy.append(Yce_N)
        S_fossil_energy.append(Yce_S)


tiempo_line = [1983 +x for x in range(1,T)]

plt.plot(tiempo_line,N_fossil_energy,label="Regiones Avanzadas")
plt.plot(tiempo_line,S_fossil_energy,label="Regiones Emergentes")
plt.legend()
plt.show()
